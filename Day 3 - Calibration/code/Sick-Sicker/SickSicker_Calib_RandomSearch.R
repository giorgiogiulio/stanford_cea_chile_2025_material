...
######  Load target data  ######
####################################################################
load("R-labs/calibration/SickSicker_CalibTargets.RData")
...
source("R-labs/calibration/SickSicker_MarkovModel_Function.R") # creates the function run_sick_sicker_markov()
